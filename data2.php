                ...
                <table id="table"  class="table text-center table-bordered">
                    ...
                    <?php foreach( $daftar_calon_siswa as $row)  : ?>
                        ...
                        <tr>
                            ...
                            <td><?= $row["agama"] ?></td>
                            <td><img src="img\foto_siswa\foto<?= $row["foto_calonsiswa"] ?>" class="img-thumbnail" alt="..." style="height: 50px;"></td>
                            <td><img src="img\akta\foto<?= $row["akta"] ?>" class="img-thumbnail" alt="..." style="height: 50px;"></td>
                            <td><?= $row["nama_ayah"] ?></td>
                            ...
                            <td><?= $row["no_hp"] ?></td>
                            <td><img src="img\kartu_keluarga\foto<?= $row["kk"] ?>" class="img-thumbnail" alt="..." style="height: 50px;"></td>
                            <td><img src="img\ijazah\foto<?= $row["ijazah"] ?>" class="img-thumbnail" alt="..." style="height: 50px;"></td>
