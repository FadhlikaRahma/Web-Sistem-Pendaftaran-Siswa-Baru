  ...
  <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #023e8a;margin-top -0.5px;margin-bottom:2px;">
    ...
    <div class="collapse justify-content-center navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav  ">
        ...
        <li class="nav-item">
          <a class="nav-link text-center active" aria-current="page" href="alurhome.php"><i class="bi bi-shuffle text-center"><br>Alur</i></a>
        </li>
        <li class="nav-item">
      ...
      <form method="post" action="cari_calonsiswa.php"class="d-flex m-1">
        <input type="text"class="form-control me-2" name="search" placeholder="cari Berdasarkan NISN" required></input>
...
<div class="container-lg">
        ...
        <div class="container border border-2 bg-light">
          <br>
      <img src="img/gambaralurr.png" class="img-fluid"style="width: 1150px;height: 530px;">
      </div>
</div>
